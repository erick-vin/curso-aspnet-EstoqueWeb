    ...
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Cadastrar(int? id)
        {
            ...
            var categoriasSelectList = new SelectList(
                categorias, nameof(CategoriaModel.IdCategoria), nameof(CategoriaModel.Nome));
            ...
            if(ModelState.IsValid)
            {
                if (id.HasValue)
                {
                    if(ProdutoExiste(id.Value))
                    {
                        ...
                        {
                            TempData["mensagem"] = MensagemModel.Serializar("Error ao alterar produto.", TipoMensagem.Erro);
                        }
                    }
                    else
                    {
